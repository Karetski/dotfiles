...
**Font**: SF Mono Terminal, Medium weight, 12pt.
...
**Fonts**: UI left at Zed defaults, 16pt. Editor buffer uses `SF Mono Terminal` Medium at 12pt, matching the Ghostty role.
